...
# import an image 
image_original = Image.open('E:/Python Tuterials/Test_Project/TKINTER/tkinter-complete-main/3 style/3_9_images/raccoon.jpg')
image_ratio = image_original.size[0] / image_original.size[1]
print(image_ratio)
image_tk = ImageTk.PhotoImage(image_original)

python_dark = Image.open('E:/Python Tuterials/Test_Project/TKINTER/tkinter-complete-main/3 style/3_9_images/python_dark.png').resize((30,30))
python_dark_tk = ImageTk.PhotoImage(python_dark)

img_ctk = ctk.CTkImage(
	light_image = Image.open('E:/Python Tuterials/Test_Project/TKINTER/tkinter-complete-main/3 style/3_9_images/python_dark.png'),
	dark_image = Image.open('E:/Python Tuterials/Test_Project/TKINTER/tkinter-complete-main/3 style/3_9_images/python_light.png'))
